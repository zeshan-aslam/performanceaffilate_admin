...
<div id="changePasswordMerchant{{$Data->login_id}}" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
           <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
               <h3 id="myModalLabel3">Change Password</h3>
           </div>
           <div class="modal-body">
           <form action="{{route('Merchant.changepassword',$Data->login_id)}}" method='POST' class="form-horizontal">
