...
<h1>Text Data of 
   ...
   @endif
    ...
    <div class='row'>
        ...
        <div class='col-lg-8'>
            <div class='card'>
                <div class='card-header bg-success text-white text-center'> Text-Links</div>
                <div class='card-body'>
...
@section('script')
    <script>
        ...
        function getTextLinks() {
            ...
            let _url = "{{ url('Program/GetTextLinks') }}/" + programId+"/"+status;
            Table = $('table')
                .on('init.dt', function() {
                ...
                .DataTable({
                    ...
                    columns: [{
                            ...
                            render: function(data, type, row) {
                                ...
                                return "<span class='label bg-success'>Text</span>";
                            }
                        },
                        {
